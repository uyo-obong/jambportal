              ...
              <form method="POST" action="{{ route('create.student') }}" enctype="multipart/form-data">
                ...
                <div class="wizard-navigation">
                  <ul>
                    ...
                    <li><a href="#institution" data-toggle="tab">Programme Details</a></li>
                </div>
                  ...
                  <div class="tab-pane" id="about">
                    <div class="row">
                      <div class="col-sm-12">
                        ...
                        <div class="col-md-3">
                          <div class="form-group">
                            <label for="number2"> Date of birth *</label>
                            <input id="number2" name="dob" type="text" class="required form-control">
                          </div>
                        </div>

                        <input id="email2" name="email" value="{{ auth()->user()->email }}" type="hidden"
                      ...
                      <div class="col-sm-12">
                        ...
                        <div class="col-sm-4 ">
                          <div class="picture-container">
                            <div class="picture">
                              <img src="{{ URL::to('studreg/img/default-avatar.png') }}" class="picture-src"
                        ...
                        <div class="col-sm-8">
                            ...
                            <div class="form-group">
                                <label for="school"> Jamb Reg. No </label>
                                <input name="jamb_reg_no" class="form-control single-select">
                              </div>

                              <div class="form-group">
                                  <label for="school"> Jamb Score </label>
                                  <input name="jamb_score" class="form-control single-select">
                                </div>
                            </div>
                        ...
                        <div class="col-sm-12">
                          <input type="hidden" name="institution" value="Federal Polytechnic, Ukana"
                ...
                <div class="wizard-footer height-wizard">
                  <div class="pull-right">
                    <input type='button' class='btn btn-next btn-fill btn-primary btn-wd btn-sm' name='next'
                      value='Next' />
                    <input type='submit' class='btn btn-finish btn-fill btn-primary btn-wd btn-sm' name='finish'
                      value='Finish' />
                  </div>
